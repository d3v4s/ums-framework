<div id="message-box" class="rounded-bottom text-white container-fluid jutify-content-center bg-blue text-center position-absolute row over-top mx-auto">
	<div class="col-1 container-fluid mx-0"></div>
