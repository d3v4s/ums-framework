<li class="dropdown">
	<a class="nav-link dropdown-toggle" href="/user/settings" data-toggle="dropdown">Account <span class="caret"></span></a>
	<ul id="dropdown-account" class="dropdown-menu mx-auto">
		...
		<li>
    		<div class="container justify-content-center text-center p-2 row mx-auto">
    			<a href="/user/settings" class="btn btn-warning m-2"><i class="fas fa-cog"></i> <?=$this->lang[DATA][SETTINGS]?></a>
