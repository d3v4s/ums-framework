<div class="container col-md-7 text-center">
    ...
    <form id="user-update-form" action="/ums/user/update" method="POST">
    	...
    	<div class="form-group text-md-right mr-md-4 mt-md-4">
    		<a class="btn btn-primary px-3 py-1 mx-2 my-2" href="/<?=USER_ROUTE.'/'.${USER}->{USER_ID}?>"><i class="fas fa-info"></i> Info</a>
    		<?php if (${CAN_CHANGE_PASSWORD}): ?>
    			<a class="btn btn-warning px-3 py-1 mx-2 my-2" href="/<?=USER_ROUTE.'/'.${USER}->{USER_ID}.'/'.PASS_UPDATE_ROUTE?>"><i class="fas fa-key"></i> Change Password</a>
			<?php endif; ?>
