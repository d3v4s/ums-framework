<div class="container col-md-10 text-left">
    ...
    <?php if (${SITE_MAP_EXISTS}): ?>
        <div class="container col-10 text-md-right text-center p-3">
        	...
        	<a href="/ums/generator/site_map/update" class="btn btn-primary mx-2 align-middle">Update site map</a>
        </div>
    <?php endif; ?>
    <form id="sitemap-generator-form" action="/ums/generator/site_map" method="post" class="p-3">
